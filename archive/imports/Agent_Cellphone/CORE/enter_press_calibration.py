#!/usr/bin/env python3
"""
Enter-Press Coordinate Calibration
=================================
Calibrate 5-agent coordinates by pressing Enter when ready
instead of using countdown timers.
"""
...
class EnterPressCalibrator:
    """Coordinate calibration using Enter key instead of countdown"""
    ...
    def run_calibration(self):
        ...
        print("🚀 ENTER-PRESS 5-AGENT COORDINATE CALIBRATION")
        print("=" * 70)
...
def main():
    ...
    try:
        calibrator = EnterPressCalibrator()
