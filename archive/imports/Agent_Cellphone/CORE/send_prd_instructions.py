#!/usr/bin/env python3
"""
Send PRD Instructions to Agents 1-4
===================================
Uses the autonomous CAPTAIN system to instruct agents to create or modify PRDs.
"""
...
def send_prd_instructions():
    ...
    # Initialize autonomous CAPTAIN with correct repository path
...
"""
        ...
        try:
            captain._send_message_smart(agent, instruction, "PRD_CREATION", new_chat=True)
